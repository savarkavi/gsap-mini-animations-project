  ...
  return (
    <div className="relative h-screen">
      {cards.map((item, i) => (
        <div
          key={item.label}
          className={`card-${i} absolute top-1/2 left-1/2 h-[500px] w-[800px] -translate-x-1/2 -translate-y-1/2 from-10% to-80% ${item.rotation} ${item.background} flex items-center justify-center rounded-lg border`}
        >
